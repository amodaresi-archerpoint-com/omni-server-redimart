...
namespace LSOmni.DataAccess.BOConnection.CentrAL.Dal
{
    public class DiscountOfferRepository : BaseRepository
    {
        ...
        public DiscountOfferRepository(BOConfiguration config) : base(config)
        {
            ...
            sqlfrom = " FROM [" + navCompanyName + "WI Discounts$5ecfc871-5d82-43f1-9c54-59685e82318d] mt" +
                      " JOIN [" + navCompanyName + "Periodic Discount$5ecfc871-5d82-43f1-9c54-59685e82318d] p ON p.[No_]=mt.[Offer No_]";
            ...
            sqlMMfrom = " FROM [" + navCompanyName + "WI Mix & Match Offer$5ecfc871-5d82-43f1-9c54-59685e82318d] mt" +
                      " JOIN [" + navCompanyName + "Periodic Discount$5ecfc871-5d82-43f1-9c54-59685e82318d] p ON p.[No_]=mt.[Offer No_]";
            ...
            sqlVfrom = " FROM [" + navCompanyName + "Validation Period$5ecfc871-5d82-43f1-9c54-59685e82318d] mt ";
        }
        ...
        public List<ReplDiscount> ReplicateDiscounts(string storeId, int batchSize, bool fullReplication, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = connection.CreateCommand())
                {
                    ...
                    if (fullReplication)
                    {
                        command.CommandText = "SELECT MAX([Entry No_]) FROM [" + navCompanyName + "Preaction$5ecfc871-5d82-43f1-9c54-59685e82318d] WHERE [Table No_]='99001453'";
                    ...
                    if (fullReplication == false)
                    {
                        foreach (JscActions a in actions)
                        {
                            ...
                            {
                                command2.CommandText = "SELECT [No_] FROM [" + navCompanyName + "Periodic Discount$5ecfc871-5d82-43f1-9c54-59685e82318d] WHERE [No_]=@0 AND [Status]=0";
        ...
        public List<ReplDiscountSetup> ReplicateDiscountSetup(int batchSize, bool fullReplication, string storeId, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            ...
            List<JscKey> keys = GetPrimaryKeys("Periodic Discount$5ecfc871-5d82-43f1-9c54-59685e82318d");
            ...
            if (fullReplication)
            {
                sql = "SELECT COUNT(*) FROM [" + navCompanyName + "Periodic Discount$5ecfc871-5d82-43f1-9c54-59685e82318d] mt" +
            ...
            sql = GetSQL(fullReplication, batchSize) +
                ...
                "FROM [" + navCompanyName + "Periodic Discount Line$5ecfc871-5d82-43f1-9c54-59685e82318d] ml " +
                "JOIN [" + navCompanyName + "Periodic Discount$5ecfc871-5d82-43f1-9c54-59685e82318d] mt ON mt.[No_]=ml.[Offer No_]" +
                GetWhereStatementWithPriceGroupFilter(fullReplication, keys, where, "mt.[Price Group]", storeId, false);
        ...
        public List<ReplDiscountValidation> ReplicateDiscountValidations(int batchSize, bool fullReplication, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            ...
            List<JscKey> keys = GetPrimaryKeys("Validation Period$5ecfc871-5d82-43f1-9c54-59685e82318d");
